...
const TextAreaUC3G = async () => {
class TextAreaUC3G extends HTMLTextAreaElement {
    constructor() {
      super();
      this.url = '';
      this.modal = '';
...
window.customElements.define("textarea-uc3g",TextAreaUC3G,{extends:'textarea'}) 
}

//LLamada del componente
export const textarea_uc3g = TextAreaUC3G()
